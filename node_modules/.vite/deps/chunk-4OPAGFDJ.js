...
function createSignal(value, options) {
  ...
  const setter = (value2) => {
    if (typeof value2 === "function") {
      if (Transition && Transition.running && Transition.sources.has(s)) value2 = value2(s.pending !== NOTPENDING ? s.pending : s.tValue);
      else value2 = value2(s.pending !== NOTPENDING ? s.pending : s.value);
    }
  ...
  return createComponent(SuspenseContext2.Provider, {
    ...
    get children() {
      return createMemo(() => {
        ...
        if (ctx && p === void 0) setHydrateContext();
...
//# sourceMappingURL=chunk-4OPAGFDJ.js.map
