    ...
    on(
      ...
      () => {
        if (processed()) {
          ...
          const layout = {
            title:
              "График зависимости вероятностей ошибок от порогового напряжения",
            showlegend: false,
          };
  ...
  return (
    <main>
      ...
      <p class="font-mono font-normal text-2xl text-center">
        Исследуем зависимость вероятностей ошибок p(1|0) p(0|1) от порогового
        напряжения V(вольт) при задаваемом напряжении сигнала Vm.
      </p>
      <Show when={!processed()}>
        <div class="bg-white flex flex-col items-center m-4">
          <span class="font-mono text-xl font-extrabold text-center mb-2">
            Введите напряжение сигнала Vm (от 0 до 5):{" "}
          </span>
          <input
