...
export default function Quest3(props) {
  ...
  return (
    <div class="container flex flex-col items-center w-2/3">
      ...
      <p class="font-mono text-2xl font-normal text-start mb-2">На вход отсчетного устройства поступает Z(t) - сигнал в сумме с нормальным шумом. Амплитуда импульса Um, дисперсия шума M2. В каких пределах с вероятностью 0.997% заключены мгновенные значения Z(t) при передаче 0 (Нуля) ?</p>
