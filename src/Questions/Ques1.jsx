...
export default function Quest1(props) {
  ...
  let options = [["x1","4"], ["x2","3"], ["x3","2"], ["x4","4"], ["x5","3"]];
...
// from 2nd question
  let options2 = [["4","100"], ["3","011"], ["2","010"], ["4","100"], ["3","011"]];
  ...
  return (
    <div class="container flex flex-col items-center w-2/3">
      ...
      <p class="font-mono text-2xl font-normal text-start">Заданы отсчеты непрерывного информационного сигнала, который необходимо
      передать с помощью ИКМ. <br />Амплитуды 5-ти импульсов-отсчетов равны:</p>
      <p class="font-mono text-xl font-bold text-center">{option}</p>
      <p class="font-mono text-2xl font-normal text-start">Выполните операцию квантования заданных импульсов-отсчетов x1, x2, x3, x4, x5. <br />Уровни квантования: 0, 1, 2, 3, 4, 5, 6, 7.</p>
      <MultiFieldForm options={options} processTag={setProcessTag}></MultiFieldForm>

      <Show when={processTag()}>
        <div class="multiline font-mono text-2xl font-normal mb-2">Выполните операцию кодирования квантованных импульсов-отсчетов. Кодовые комбинации - двоичные, из 3 импульсов.</div>
