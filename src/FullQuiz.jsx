...
export default function FullQuiz(props) {
  ...
  return (
    <div class="container flex flex-col items-center w-2/3">
      ...
      <Quiz options={questions} initialAnswer={initAns} shuffledAnswer={[answer, setAnswer]}></Quiz>
      <p class="font-mono text-xl font-bold mt-4">Введите номер правильного ответа:</p>
